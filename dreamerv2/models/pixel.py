...
class ObsEncoder(nn.Module):
    def __init__(self, input_size, embedding_size, info):
        super(ObsEncoder, self).__init__()
        activation = info['activation']
        hidden_size = info.get('hidden_size', 256)  # An example hidden size
...
class ObsDecoder(nn.Module):
    def __init__(self, output_size, embed_size, info):
