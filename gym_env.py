...
class Environment(Env):
    def __init__(self, world_name: str, freq: int = 100, has_predator: bool = False, real_time: bool = True, prey_agent:Agent=None, max_step = 200):
    ...
    def step(self, action):
        ...
        obs.append(location.y)
        obs.append(goal_location.x)
        obs.append(goal_location.y)
        obs = np.array(obs)
